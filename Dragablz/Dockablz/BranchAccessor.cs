...
namespace Dragablz.Dockablz
{
    public class BranchAccessor
    {
        ...
        public BranchAccessor FirstItemBranchAccessor => m_firstItemBranchAccessor;

        public BranchAccessor SecondItemBranchAccessor => m_secondItemBranchAccessor;

        public TabablzControl FirstItemTabablzControl => m_firstItemTabablzControl;

        public TabablzControl SecondItemTabablzControl => m_secondItemTabablzControl;
